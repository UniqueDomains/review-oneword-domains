# Available .REVIEW One-Word Domains (5,621,975)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C749%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-5%2C621%2C975%20domains-6f42c1">
...
> **Important:** this repository is a **public 9,749-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,621,975 domains** on the canonical page below.

**Public extract:** 9,749 rows · **Live catalog:** 5,621,975 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/review?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_review_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/review?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_review_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./review.csv">CSV</a> / <a href="./review.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_review_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_review_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .REVIEW search](https://unique.domains/domains/tld/review?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_review_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .REVIEW search](https://unique.domains/domains/tld/review?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_review_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./review.csv) or [Download JSON](./review.json)
...
| ----------------------- | ------------------------------------------------ |
| 9,749-row public sample | 5,621,975 live domains                           |
...
| actionable.review | available | $15.73    | —             | 88             | 15     | 10     | namecheap        |
| newyear.review    | resell    | —         | —             | —              | 11     | 8      | Dynadot Inc      |
| seventeen.review  | premium   | $437.50   | $62.50        | 84             | 62     | 9      | name.com         |
| twentytwo.review  | available | $15.73    | —             | 84             | 14     | 10     | namecheap        |
| ace.review        | premium   | $625      | $81.25        | 88             | 57     | 3      | name.com         |
| playing.review    | available | $15.73    | —             | 74             | 14     | 7      | namecheap        |
...
> Unique Domains. *Available .REVIEW One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
